    ...
    RGraph.Drawing.Marker2.prototype.Draw = function ()
    {
        ...
        */
        this.context.beginPath();
            ...
            this.context.fillRect(AA(this, this.x),
                                  AA(this, this.y - this.metrics[1] - 6 - this.properties['chart.voffset']),
                                  this.metrics[0] + 6,
                                  this.metrics[1] + 6);
        this.context.fill();
        
        // Store these coords as the coords of the label
        this.coords[0] = [AA(this, this.x),AA(this, this.y - this.metrics[1] - 6 - this.properties['chart.voffset']),this.metrics[0] + 6,this.metrics[1] + 6]
        ...
        */
        this.context.beginPath();
            this.context.moveTo(AA(this, this.x + (this.positionLeft ? this.metrics[0] + 6 : 0) ), this.y - this.properties['chart.voffset']);
            this.context.lineTo(AA(this, this.x + (this.positionLeft ? this.metrics[0] + 6 : 0)), this.y - 3);
        this.context.stroke();
        ...
        */
        this.context.beginPath();
            ...
            this.context.strokeRect(AA(this, this.x),
                                    AA(this, this.y - this.metrics[1] - 6 - this.properties['chart.voffset']),
                                    this.metrics[0] + 6,
                                    this.metrics[1] + 6);
        this.context.stroke();
    ...
    */
    RGraph.Drawing.Marker2.prototype.positionTooltip = function (obj, x, y, tooltip, idx)
    {
        ...
        tooltip.style.top  = canvasXY[1] + this.coords[0][1] - height + (textDimensions[1] / 2) + 'px';
