...
class Quest_model extends MY_Model
{
    ...
    public function joinQuest($data)
    {
        ...
        log_message('debug', 'MISSION : player = '.$data["pb_player_id"].' quest id = '.$data["quest_id"].' before sort : '.var_dump($data["missions"]));

        $data["missions"] = vsort($data["missions"], "mission_number");

        log_message('debug', 'MISSION : player = '.$data["pb_player_id"].' quest id = '.$data["quest_id"].' after sort : '.var_dump($data["missions"]));
        ...
        log_message('debug', 'MISSION : player = '.$data["pb_player_id"].' quest id = '.$data["quest_id"].' update status : '.var_dump($data["missions"]));
