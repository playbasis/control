...
//		return $badgeSet;
        ...
        $this->memcached_library->add('sql_' . $md5query.".".$table, $badgeSet);
...
//		return $collectionSet;
        ...
        $this->memcached_library->add('sql_' . $md5query.".".$table, $collectionSet);
...
//		return $collection;
        ...
        $this->memcached_library->add('sql_' . $md5query.".".$table, $collection);
