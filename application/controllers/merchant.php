...
//                $data['client_id'] = $this->User_model->getClientId();
//                $data['site_id'] = $this->User_model->getSiteId();
//                $data['name'] = $merchant_data['name'];
//                $data['desc'] = $merchant_data['description'];
//                $data['date_start'] = $merchant_data['date_start'];
//                $data['date_end'] = $merchant_data['date_end'];
//                $data['image'] = $merchant_data['image'];
//                $data['status'] = $merchant_data['status'] == 'enable' ? true : false;
//
...
//    }
    ...
    public function getForm($merchant_id = null)
    {
        ...
        if ($this->input->post('name')) {
            ...
            $this->data['name'] = $merchant_info['name'];
        } else {
            $this->data['name'] = '';
        }
