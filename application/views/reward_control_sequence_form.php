    ...
    <div class="box">
        <div class="heading">
            ...
            <div class="buttons">
                ...
                <button class="btn btn-info" onclick="location = baseUrlPath+'reward_control'" type="button"><?php echo $this->lang->line('button_cancel'); ?></button>
            </div>
        </div>
        <div class="content">
...
<script type="text/javascript">
    ...
    function downloadFile(){
        ...
        location = baseUrlPath+'reward_control/getSequenceFile?file_name='+file_name+'&file_id='+file_id;
