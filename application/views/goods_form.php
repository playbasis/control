                ...
                <div id="tab-general">
                        <table class="form">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" class="date" name="date_start" value="<?php if (strtotime(datetimeMongotoReadable($date_start))) { ?><?php echo date('Y-m-d', strtotime(datetimeMongotoReadable($date_start))); ?><?php } else { ?>HELLO<?php } ?>" size="50" />
                                </td>
                            </tr>
                            <tr>
                                <td><?php echo $this->lang->line('entry_expire_date'); ?>:</td>
                                <td>
                                    <input type="text" class="date" name="date_expire" value="<?php if (strtotime(datetimeMongotoReadable($date_expire))) { ?><?php echo date('Y-m-d', strtotime(datetimeMongotoReadable($date_expire))); ?><?php } else { ?>HELLO<?php } ?>" size="50" />
                                </td>
                            </tr>
                        </table>
