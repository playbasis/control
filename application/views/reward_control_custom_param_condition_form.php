    ...
    <div class="box">
        <div class="heading">
            ...
            <div class="buttons">
                ...
                <button class="btn btn-info" onclick="location = baseUrlPath+'reward_control/custom_param_condition'" type="button"><?php echo $this->lang->line('button_cancel'); ?></button>
            </div>
        </div>
        <div class="content">
...
<script type="text/javascript">
    ...
    function showDemo(){
        ...
        filename = "custom_param_condition_example.csv";
    ...
    function downloadFile(){
        ...
        location = baseUrlPath+'reward_control/getCustomParamConditionFile?file_name='+file_name+'&file_id='+file_id;
