    ...
    <div id="tab-domain">
        <table class="form">
                ...
                <td>
                        <div class="select-platform-wrapper">
                                ...
                                $data1 = array(
                                    ...
                                    'name'        => 'platform',
                                    'value'       => 'web',
                                    'checked'     => set_value('platform')?(set_value('platform')=='web'?TRUE:FALSE):TRUE
                                );
                                ...
                                $data2 = array(
                                    ...
                                    'name'        => 'platform',
                                    'value'       => 'ios',
                                    'checked'     => set_value('platform')?(set_value('platform')=='ios'?TRUE:FALSE):FALSE
                                );
                                ...
                                $data3 = array(
                                    ...
                                    'name'        => 'platform',
                                    'value'       => 'android',
                                    'checked'     => set_value('platform')?(set_value('platform')=='android'?TRUE:FALSE):FALSE
                                );
            ...
            <tr class="app-tab web">
                ...
                <td><input type="text" name="site_url" value="<?php echo set_value('site_url'); ?>" size="50" /> <span class="muted">ex. http://www.example.com</span></td>
            </tr>
            <tr class="app-tab ios">
                <td><span class="required">*</span> Bundle ID:</td>
                <td><input type="text" name="ios_bundle_id" value="<?php echo set_value('ios_bundle_id'); ?>" size="50" /> <span class="muted">ex. com.companyname.appname</span></td>
            </tr>
            <tr class="app-tab ios">
                <td>iPhone Store ID</td>
                <td><input type="text" name="ios_iphone_store_id" value="<?php echo set_value('ios_iphone_store_id'); ?>" size="50" /> <span class="muted">ex. 544007664</span></td>
            </tr>
            <tr class="app-tab ios">
                <td>iPad Store ID</td>
                <td><input type="text" name="ios_ipad_store_id" value="<?php echo set_value('ios_ipad_store_id'); ?>" size="50" /> <span class="muted">ex. 544007664</span></td>
            </tr>
            <tr class="app-tab android">
                <td><span class="required">*</span> Package Name:</td>
                <td><input type="text" name="android_package_name" value="<?php echo set_value('android_package_name'); ?>" size="50" /> <span class="muted">ex. com.companyname.appname</span></td>
            </tr>
        </table>
    </div>
<?php
