    ...
    <div class="box">
        ...
        <div class="content">
                <div id="tabs" class="htabs">
                    ...
                    <a href="<?php echo site_url('calendar/event');?>" class="selected" style="display: inline;"><?php echo $this->lang->line('tab_event'); ?></a>
            ...
            <?php if (isset($calendar)) { ?>
                <?php echo form_open('calendar/event', array('id' => 'form')); ?>
                <table class="list">
                    <thead>
                    <tr>
