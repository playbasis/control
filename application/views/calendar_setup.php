    ...
    <div class="box">
        ...
        <div class="content">
            ...
            <?php if (isset($calendar)) { ?>
                ...
                <a href="<?php echo $calendar['google_url'].'?client_id='.$calendar['google_client_id'].'&response_type=code&scope=https://www.googleapis.com/auth/calendar.readonly&redirect_uri='.base_url().'calendar/authorize&access_type=offline&approval_prompt=force'; ?>" class="btn btn-success btn-mini">Authorize</a>
                <?php } ?>
            <?php } else { ?>
